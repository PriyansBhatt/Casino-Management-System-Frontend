...
export const ROUTE_PERMISSIONS = {
  ...
  '/pit/tables/:tableId/mode': [ROLES.SUPER_ADMIN, ROLES.PIT_SUPERVISOR, ROLES.DEALER],
  ...
  '/audit-logs': [ROLES.SUPER_ADMIN, ROLES.DIRECTOR],
  '/audit-logs/:id': [ROLES.SUPER_ADMIN, ROLES.DIRECTOR],
  '/audit/reports': AUDIT_ROLES,
  '/analytics/management': REPORT_ROLES,
  '/fnb': [ROLES.SUPER_ADMIN, ROLES.DIRECTOR],
