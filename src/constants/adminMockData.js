...
export const ADMIN_MOCK_USERS = [
  ...
  { id: '6', fullName: 'Pit Supervisor User', username: 'pitsupervisor', role: ROLES.PIT_SUPERVISOR, department: 'Pit', email: 'pitsupervisor@casino.local', phone: '9800000006', status: USER_STATUSES.ACTIVE, createdAt: now, updatedAt: now },
