...
const createDemoData = () => {
  ...
  const auditLogs = [
    ...
    { id: '4', reference: 'AUD-DEMO-004', module: 'PIT', action: 'CLOSE_SESSION', severity: 'HIGH', description: 'Table session closed pending review.', businessDate: BUSINESS_DATE, performedBy: 'pitsupervisor', performedByRole: 'PIT_SUPERVISOR', entityType: 'TABLE_SESSION', entityId: '3', newValue: pitSessions[2], createdAt },
